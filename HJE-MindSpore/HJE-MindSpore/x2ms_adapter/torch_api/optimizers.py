...
def _clip_grad_value(gradients):
    clip_value = x2ms_context.clip_grad_value
    new_grads = ()
    for grad in gradients:
        new_grads += (mindspore.ops.composite.clip_by_value(
            grad, clip_value_max=mindspore.Tensor(clip_value)),)
    return new_grads
...
class Adam(mindspore.nn.Adam, OptimAdaptorMixIn):
    def __init__(self, params, **kwargs):
        ...
        super(Adam, self).__init__(new_params, **kwargs)
    ...
    def construct(self, gradients):
        ...
        if x2ms_context.clip_grad_value is not None:
            gradients = _clip_grad_value(gradients)
...
class SGD(mindspore.nn.SGD, OptimAdaptorMixIn):
    def __init__(self, params, **kwargs):
        new_params = params_dict_to_list(params)
        super(SGD, self).__init__(new_params, **kwargs)
        _record_args(self, kwargs, params)
        self.x2ms_param_groups = create_param_groups_modifiers(self)
...
class RMSprop(mindspore.nn.RMSProp, OptimAdaptorMixIn):
    def __init__(self, params, **kwargs):
        new_params = params_dict_to_list(params)
        super(RMSprop, self).__init__(new_params, **kwargs)
        _record_args(self, kwargs, params)
        self.x2ms_param_groups = create_param_groups_modifiers(self)
...
class Rprop(mindspore.nn.Rprop, OptimAdaptorMixIn):
    def __init__(self, params, **kwargs):
        new_params = params_dict_to_list(params)
        super(Rprop, self).__init__(new_params, **kwargs)
        _record_args(self, kwargs, params)
        self.x2ms_param_groups = create_param_groups_modifiers(self)
...
class Adagrad(mindspore.nn.Adagrad, OptimAdaptorMixIn):
    def __init__(self, params, **kwargs):
        new_params = params_dict_to_list(params)
        super(Adagrad, self).__init__(new_params, **kwargs)
        _record_args(self, kwargs, params)
        self.x2ms_param_groups = create_param_groups_modifiers(self)
...
class ASGD(mindspore.nn.ASGD, OptimAdaptorMixIn):
    def __init__(self, params, **kwargs):
        new_params = params_dict_to_list(params)
        super(ASGD, self).__init__(new_params, **kwargs)
        _record_args(self, kwargs, params)
        self.x2ms_param_groups = create_param_groups_modifiers(self)
...
if LooseVersion(mindspore.__version__) < LooseVersion('1.8.0'):
    class AdamW(mindspore.nn.AdamWeightDecay, OptimAdaptorMixIn):
        def __init__(self, params, **kwargs):
            new_params = params_dict_to_list(params)
            super(AdamW, self).__init__(new_params, **kwargs)
            _record_args(self, kwargs, params)
            self.x2ms_param_groups = create_param_groups_modifiers(self)
    ...
    class Adamax(mindspore.nn.AdaMax, OptimAdaptorMixIn):
        def __init__(self, params, **kwargs):
            new_params = params_dict_to_list(params)
            super(Adamax, self).__init__(new_params, **kwargs)
            _record_args(self, kwargs, params)
            self.x2ms_param_groups = create_param_groups_modifiers(self)
    ...
    class Adadelta(mindspore.nn.Adadelta, OptimAdaptorMixIn):
        def __init__(self, params, **kwargs):
            new_params = params_dict_to_list(params)
            super(Adadelta, self).__init__(new_params, **kwargs)
            _record_args(self, kwargs, params)
            self.x2ms_param_groups = create_param_groups_modifiers(self)
