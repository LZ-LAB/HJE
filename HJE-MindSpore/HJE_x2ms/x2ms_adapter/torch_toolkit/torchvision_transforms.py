...
class Resize(ms_data_transforms_api_map.get('Resize')):
...
class Compose(ms_data_transforms_api_map.get('Compose')):
...
class RandomResizedCrop(ms_data_transforms_api_map.get('RandomResizedCrop')):
    interpolation_map = {
...
class RandomResizedCropAndInterpolation(ms_data_transforms_api_map.get('RandomResizedCrop')):
    interpolation_map = {
...
class RandomHorizontalFlip(ms_data_transforms_api_map.get('RandomHorizontalFlip')):
    def __init__(self, p=0.5):
        super().__init__(prob=p)


class RandomVerticalFlip(ms_data_transforms_api_map.get('RandomVerticalFlip')):
    def __init__(self, p=0.5):
        super().__init__(prob=p)


class ToTensor(ms_data_transforms_api_map.get('ToTensor')):
...
class ColorJitter(ms_data_transforms_api_map.get('RandomColorAdjust')):
    pass


class RandomRotation(ms_data_transforms_api_map.get('RandomRotation')):
...
class RandomErasing(ms_data_transforms_api_map.get('RandomErasing')):
    def __init__(self, p=0.5, scale=(0.02, 0.33), ratio=(0.3, 3.3), value=0, inplace=False):
        super().__init__(prob=p, scale=scale, ratio=ratio, value=value, inplace=inplace)


class TenCrop(ms_data_transforms_api_map.get('TenCrop')):
    def __init__(self, size, vertical_flip=False):
        super().__init__(size=size, use_vertical_flip=vertical_flip)


class RandomAffine(ms_data_transforms_api_map.get('RandomAffine')):
...
class RandomApply(ms_data_transforms_api_map.get('RandomApply')):
    def __init__(self, transforms, p=0.5):
        super().__init__(transforms=transforms, prob=p)


class RandomPosterize(ms_data_transforms_api_map.get('RandomPosterize')):
...
class RandomGrayscale(ms_data_transforms_api_map.get('RandomGrayscale')):
    def __init__(self, p=0.1):
        super().__init__(prob=p)


class RandomPerspective(ms_data_transforms_api_map.get('RandomPerspective')):
...
class Pad(ms_data_transforms_api_map.get('Pad')):
...
class LinearTransformation(ms_data_transforms_api_map.get('LinearTransformation')):
...
class RandomSolarize(ms_data_transforms_api_map.get('RandomSolarize')):
...
class RandomChoice(ms_data_transforms_api_map.get('RandomChoice')):
...
class AutoAugment(ms_data_transforms_api_map.get('AutoAugment')):
...
class RandomAdjustSharpness(ms_data_transforms_api_map.get('RandomAdjustSharpness')):
    def __init__(self, sharpness_factor, p=0.5):
        super().__init__(degree=sharpness_factor, prob=p)


class RandomAutocontrast(ms_data_transforms_api_map.get('RandomAutoContrast')):
    def __init__(self, p=0.5):
        super().__init__(prob=p)


class RandomEqualize(ms_data_transforms_api_map.get('RandomEqualize')):
    def __init__(self, p=0.5):
        super().__init__(prob=p)


class RandomInvert(ms_data_transforms_api_map.get('RandomInvert')):
    def __init__(self, p=0.5):
        super().__init__(prob=p)


class CenterCrop(ms_data_transforms_api_map.get('CenterCrop')):
    pass


class RandomCrop(ms_data_transforms_api_map.get('RandomCrop')):
    pass


class RandomOrder(ms_data_transforms_api_map.get('RandomOrder')):
    pass


class FiveCrop(ms_data_transforms_api_map.get('FiveCrop')):
    pass


class GaussianBlur(ms_data_transforms_api_map.get('GaussianBlur')):
    pass


class Grayscale(ms_data_transforms_api_map.get('Grayscale')):
    pass
